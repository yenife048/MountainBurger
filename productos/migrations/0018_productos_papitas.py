# Generated by Django 3.2.7 on 2023-05-24 20:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('productos', '0017_productos_alitas'),
    ]

    operations = [
        migrations.CreateModel(
            name='productos_papitas',
            fields=[
            ...
            options={
                'verbose_name': 'producto_papa',
                'verbose_name_plural': 'productos_papas',
                'ordering': ['created'],
            },
        ),
    ]
